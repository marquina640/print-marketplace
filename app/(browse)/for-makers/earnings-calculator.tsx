    ...
    <div className="rounded-2xl bg-[#1a1535] text-white p-6 space-y-6">
      ...
      <div className="space-y-5">
        ...
        <div>
          <div className="flex justify-between text-sm mb-2">
            ...
            <span className="font-bold text-[#D4A017]">CHF {avgJobValue}</span>
          </div>
          <input
          ...
          />
          <div className="flex justify-between text-xs text-[#9d97c4] mt-1">
            <span>CHF 10</span><span>CHF 200</span>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-xl bg-white/10 p-4 flex items-center justify-between">
        <div>
          ...
          <p className="text-3xl font-black text-white">CHF {net.toLocaleString()}</p>
          <p className="text-xs text-[#9d97c4] mt-0.5">after 12% platform fee</p>
        </div>
        <div className="text-right text-xs text-[#9d97c4] space-y-1">
          <p>{jobsPerWeek} × CHF {avgJobValue} × 4 weeks</p>
          <p>= CHF {gross.toLocaleString()} gross</p>
          <p>− 12% = <span className="text-white font-semibold">CHF {net.toLocaleString()}</span></p>
        </div>
      </div>
