  ...
  return (
    <div className="space-y-5 text-warm-700 leading-relaxed text-[15px]">
      <p className="text-lg text-warm-700 leading-relaxed">
        3D printing prices vary wildly — from a few francs to several hundred — and if you&apos;ve ever tried to get a quote online, you&apos;ve probably noticed that the numbers rarely make intuitive sense. Here&apos;s a clear breakdown of what actually drives cost, and what you should expect to pay in Switzerland.
      </p>
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-xl border border-warm-200 bg-warm-50 p-4">
          ...
          <p className="text-sm">Ordering 10 identical parts isn&apos;t 10× the cost of one — setup time is shared and makers can often nest multiple parts on the print bed. Expect a per-unit discount for quantities above 3–5.</p>
        </div>
      </div>

      <h2 className="text-xl font-bold text-ink-900 mt-8 mb-3">Typical price ranges by material (Switzerland, 2025)</h2>
      <div className="overflow-x-auto">
        <table className="w-full text-sm border-collapse">
          ...
          <tbody className="divide-y divide-warm-100">
            {[
              ['PLA', 'CHF 5 – 30', 'Prototypes, decorative, low-stress parts'],
              ['PETG', 'CHF 8 – 40', 'General use, food-safe, slightly flexible'],
              ['ABS', 'CHF 10 – 45', 'Mechanical parts, heat resistance'],
              ['TPU (flexible)', 'CHF 12 – 50', 'Phone cases, gaskets, grips'],
              ['Resin (SLA)', 'CHF 15 – 80', 'Ultra-fine detail, miniatures, dental/jewellery'],
              ['Nylon / PA12', 'CHF 25 – 120', 'Engineering, load-bearing, impact resistance'],
              ['Polycarbonate', 'CHF 30 – 150', 'Extreme heat/impact applications'],
            ].map(([mat, range, use]) => (
      ...
      <p className="text-xs text-warm-400">Ranges are indicative for a single part roughly 5–15 cm in size. Complex geometry, tight tolerances, or large parts will cost more.</p>

      <h2 className="text-xl font-bold text-ink-900 mt-8 mb-3">Why local Swiss makers can beat online services on price</h2>
      <p>
        International online services (Shapeways, Sculpteo, etc.) add significant overhead — centralised operations, warehouse handling, international shipping, and customs at the Swiss border. A local maker has lower overhead and charges only for their time and materials.
      </p>
      <p>
        For standard FDM jobs in PLA or PETG — which covers the vast majority of requests — a local maker on PrintMarketHub will almost always be faster, cheaper, and more flexible than an online service.
      </p>
      ...
      <div className="mt-8 rounded-2xl bg-[#1a1535] text-white p-6 space-y-3">
        ...
        <p className="text-[#CEC8E4] text-sm">Post a request, receive quotes from local makers, and compare. No commitment required.</p>
        <Link href="/jobs/new"
