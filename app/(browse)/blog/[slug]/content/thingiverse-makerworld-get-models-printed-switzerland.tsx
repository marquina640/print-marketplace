...
export default function Post() {
  return (
    <div className="space-y-5 text-warm-700 leading-relaxed text-[15px]">
      ...
      <p>
        Other good sources: <strong>Printables</strong> (by Prusa), <strong>MyMiniFactory</strong>, and <strong>Cults3D</strong> for premium or paid models.
      </p>
      ...
      <ol className="list-decimal pl-5 space-y-3 mt-2">
        ...
        <li>
          <strong>Submit</strong> - makers near you will receive your request and send quotes. Most jobs hear back within a few hours.
        </li>
      </ol>

      <h2 className="text-xl font-bold text-ink-900 mt-8 mb-3">What happens after you submit?</h2>
      <p>
        Makers browse open requests on their dashboard. When they see yours, they can view the model from the link you provided, check if they have the right material, and send you a quote with their price and lead time. You&apos;ll get a notification for each quote.
      </p>
      <p>
      ...
      <div className="mt-8 rounded-2xl bg-[#1a1535] text-white p-6 space-y-3">
        ...
        <p className="text-[#CEC8E4] text-sm">Paste it into your request and get quotes from makers near you within hours.</p>
        <Link href="/jobs/new"
